\subsection{Sicherheitsaspekte der Android-Architektur}
...
\end{flushleft}
	...
	Durch dieses Vorgehen bekommt jede Applikation ihren eigenen Speicherbereich, welcher nur für diese zugänglich ist. Durch dieses Rechtesystem wird versucht sicherzustellen, dass kein Nutzerprogramm als \textit{root} ausgeführt wird.
