...
\subsubsection{Sandboxing und Rechte}
\subsection[Unterschiede]{Unterschiede}
\subsubsection{Hardwaresicherheit TEE: iOS (SE) und Android (ARM
TrustZone)}
\subsubsection{Rechtsystem: Android (SELinux) und iOS (UNIX und Entitlements)}
\section{}
